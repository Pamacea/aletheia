import { TrophyIcon } from '@/ui/components/CustomIcons';
...
export default async function AchievementsPage() {
  ...
  return (
    <ProfileLayout
      title="Achievements"
      subtitle={`${unlockedCount} / ${achievements.length} débloqués`}
    >
      {/* Learning Category */}
      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h3 className={`font-semibold ${isUnlocked ? 'text-sepia-900' : 'text-ink-light'}`}>
              {name}
            </h3>
            {isUnlocked && (
