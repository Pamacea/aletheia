...
// Loader2 Icon - Loader animé
export function Loader2Icon({ className, style }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Loader Icon - Spinner de chargement complet
export function LoaderIcon({ className, style }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
// Settings Icon - Alias for CogIcon (Profile settings)
export function SettingsIcon({ className, style }: IconProps) {
  return CogIcon({ className, style });
}

// RefreshCw Icon - Refresh/Reload
