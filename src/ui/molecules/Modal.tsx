  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className={cn(
          "w-full max-w-[clamp(20rem,90vw,40rem)] border border-paper-300 bg-white shadow-xl",
          className
        )}
      ...
      >
        ...
        {footer && (
          <div className="border-t border-paper-200 px-4 sm:px-6 py-3 sm:py-4">{footer}</div>
        )}
      </div>
    </div>
  );
